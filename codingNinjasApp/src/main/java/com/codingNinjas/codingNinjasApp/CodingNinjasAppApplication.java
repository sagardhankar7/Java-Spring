...
public class CodingNinjasAppApplication {
	...
	public static void main(String[] args) {
		...
		switch (option) {
			case 1:
				paidCourse.setCourseDetails("Java Course");
				break;
			case 2:
				paidCourse.setCourseDetails("Spring Framework");
				break;
		}
...
////		PaidCourse javaCourse = context.getBean()
...
//		javaCourse.getInstructor().setInstructorDetails("Rohan Singh", "26");
