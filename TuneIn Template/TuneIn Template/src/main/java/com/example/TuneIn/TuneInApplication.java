...
//        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContext.xml");
        ...
        System.out.println("Your Playlist with reference Id: @" + user.toString().split("@")[1] + " is Ready!!");
        for (Song song : user.getPlaylist().getPlaylistSongs()) {
            System.out.println("Song name: " + song.getSongName() + "\t Reference Id: @" + song.toString().split("@")[1]);
        }
